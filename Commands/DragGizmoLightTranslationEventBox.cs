...
public class DragGizmoLightTranslationEventBoxCommand : IBeatmapEditorCommand, IBeatmapEditorCommandWithHistory
{
   ...
   public DragGizmoLightTranslationEventBoxCommand(
      DragGizmoLightTranslationEventBoxSignal signal,
      SignalBus signalBus,
   ...
   public void Execute()
   {
      ...
      _event = LightTranslationBaseEditorData.CreateNew(
         beat,
         _eventBoxGroupsState.lightTranslationEaseLeadType,
         _eventBoxGroupsState.lightTranslationEaseCurveType,
